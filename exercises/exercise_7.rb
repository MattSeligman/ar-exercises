...
users_suggested_name = $stdin.gets.chomp

#@new_store = Store.create(name: users_suggested_name, annual_revenue: 0, mens_apparel: true, womens_apparel: true)
@new_store = Store.create(name: users_suggested_name)
